        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    ...
                    "Sua escolha se baseia em sua mente, então o mundo é apenas um obstáculo que interfere em seu caminho, sua escolha foi a certo ponto egoísta.",
                ]
            ...
            },
            {
                ...
                afirmacao: [
                    " O ato de sacrifício define a essência do heroísmo. Você escolheu colocar o bem maior acima do seu próprio, mostrando coragem e compaixão inigualáveis.",
                    " Seu ato de sacrificio, fez com que o mundo prosperace, em alguns casos, sua atitude foi certa",
                ]
            }
        ]
    },
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    " Seu filme seria um jogo psicológico de intrigas e mistérios, onde as sombras do desconhecido dominam a narrativa, e cada decisão tem um peso sombrio. ",
                    " Seus gostos se baseiam em algo mais macabro, ótima escolha para pessoas dark🤓👆",
                ]
            },
            {
                texto: " Um filme que traz esperança com atos heróicos e harmonia",
                afirmacao: [
                    " Você seria o símbolo de esperança, inspirando através de seus atos corajosos  e criando um legado de bondade e justiça em um mundo que anseia por redenção. Sua história seria uma jornada de superação, onde o bem triunfa sobre as adversidades, deixando uma marca positivas no coração e todos que a assistem. ",
                    " Seu gosto é algo peculiar entre muitas pessoas, como algo mais tranquilo.",
                ]
            }
        ]
    },
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    " Seu ato de bondade em meio à escuridão é um sinal de uma alma nobre e empática. Embora o risco seja real, sua escolha revela um compromisso inabalável com a humanidade. ",
                    " Mesmo em um local estranho, você ainda se arrisca para ajudar o próximo, isso é uma ótima atitude 👍"
                ]
            },
            {
